    ...
    <nav className="w-full bg-gradient-to-b from-blue-300 to-transparent fixed top-0 left-0 right-0 z-50">
      <div className="max-w-screen-2xl mx-auto w-full px-4 sm:px-6 md:px-12 lg:px-16 xl:px-20 py-3 sm:py-4 md:py-5 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-8 xl:gap-12">
          ...
          {/* Contact Button */}
          <button className="bg-[#C29343] hover:bg-yellow-700 text-white px-3 md:px-4 lg:px-5 py-2 rounded-[10px] font-semibold flex items-center gap-2 transition font-outfit text-xs md:text-sm lg:text-base whitespace-nowrap">
